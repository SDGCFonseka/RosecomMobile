                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header m-1">
                                <a href="addSupplierModal.php" class="btn btn-success li-modal" data-toggle="modal" data-target="#myModal" data-backdrop="static"><i class="fas fa-plus"></i>&nbsp;Add Supplier</a>
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    <div id="suppTbReload">
                                        <table id="supplierTable" class="table nowrap table-striped text-center" width="100%">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr scope="row">
                                                        ...
                                                        <td><?php echo $row['company_address1'] . ' <br>' . $row['company_address2'] . ' <br>' .  $row['company_address2']; ?></td>
                                                        <td><?php echo $row['supplier_name']; ?></td>
                                                        <td><?php echo $row['supplier_email']; ?></td>
                                                        <td>

                                                            <a href="editSupplierModal.php?id=<?php echo base64_encode($row['supplier_id']); ?>" class="btn btn-outline-info li-modal crud-btn" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="far fa-edit"></i>&nbsp;Edit</a>

                                                            <a href="supplierViewModal.php?id=<?php echo base64_encode($row['supplier_id']); ?>" class="btn btn-outline-secondary li-modal crud-btn" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="far fa-eye"></i>&nbsp;View</a>

                                                        </td>
                                                        <td>
                                                            <!-------------Active------------------>
                                                            <button href="javaScript:void(0)" onclick="activeInactiveSupplier('<?php echo base64_encode($row['supplier_id']); ?>',0)" class="btn btn-outline-success crud-btn" style="display:<?php echo $buttonInActive; ?>;width: 110px;"><i class="fas fa-toggle-on"></i>&nbsp;Active</button>
                                                            <!--------------Inactive------------------->
                                                            <button href="javaScript:void(0)" onclick="activeInactiveSupplier('<?php echo base64_encode($row['supplier_id']); ?>',1)" class="btn btn-outline-danger crud-btn" style="display:<?php echo $buttonActive; ?>;width: 110px;"><i class="fas fa-toggle-off"></i>&nbsp;Deactive</button>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
