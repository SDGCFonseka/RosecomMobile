        ...
        <div id="content">
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <a href="#" class="navbar-brand">Customer Management</a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header m-1">
                                <a href="addCustomerModal.php" class="btn btn-success li-modal" data-toggle="modal" data-target="#myModal" data-backdrop="static"><i class="fas fa-plus"></i>&nbsp;Add Customer</a>
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    <div id="customerTbReload">
                                        <table id="customerTable" class="table nowrap table-striped text-center" width="100%">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr scope="row">
                                                        ...
                                                        <td><img src="../../img/customer_profile_images/<?php echo $row['customer_profile_image']; ?>" style="width:50px;height:50px;border-radius:2px;" /></td>
                                                        <td><?php echo $row['customer_first_name'] . ' ' . $row['customer_last_name']; ?></td>
                                                        <td><?php echo $row['customer_nic']; ?></td>
                                                        <td><?php echo $row['customer_address1'] . ' <br>' . $row['customer_address2'] . ' <br>' . $row['customer_city']; ?></td>
                                                        <td><?php echo $row['customer_email']; ?></td>
                                                        <td>

                                                            <a href="editCustomerModal.php?id=<?php echo base64_encode($row['customer_id']); ?>" class="btn btn-outline-info li-modal crud-btn" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="far fa-edit"></i>&nbsp;Edit</a>

                                                            <a href="customerViewModal.php?id=<?php echo base64_encode($row['customer_id']); ?>" class="btn btn-outline-secondary li-modal crud-btn" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="far fa-eye"></i>&nbsp;View</a>

                                                        </td>
                                                        <td>
                                                            <!-------------Active------------------>
                                                            <button href="javaScript:void(0)" onclick="activeInactiveCustomer('<?php echo base64_encode($row['customer_id']); ?>',0)" class="btn btn-outline-success crud-btn" style="display:<?php echo $buttonInActive; ?>;width: 110px;"><i class="fas fa-toggle-on"></i>&nbsp;Active</button>
                                                            <!--------------Inactive------------------->
                                                            <button href="javaScript:void(0)" onclick="activeInactiveCustomer('<?php echo base64_encode($row['customer_id']); ?>',1)" class="btn btn-outline-danger crud-btn" style="display:<?php echo $buttonActive; ?>;width: 110px;"><i class="fas fa-toggle-off"></i>&nbsp;Deactive</button>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
