                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header m-1">
                                <a href="addBrandModal.php" class="btn btn-success li-modal" data-toggle="modal" data-target="#myModal" data-backdrop="static"><i class="fas fa-plus"></i>&nbsp;Add Brand</a>
                            </div>
...
<div class="table-responsive">
                                    <div id="brandTbReload">
                                        <table id="brandTable" class="table nowrap table-striped text-center" width="100%">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr scope="row">
                                                        ...
                                                        <td>
                                                            <img src="../../img/brand_images/<?php echo $row['brand_image']; ?>" style="width:auto;height:60px;border-radius:2px;" />
                                                        </td>
                                                        <td><?php echo $row['brand_name']; ?></td>
                                                        <td>

                                                            <a href="editBrandModal.php?id=<?php echo base64_encode($row['brand_id']); ?>" class="btn btn-outline-info li-modal crud-btn" data-backdrop="static" data-toggle="modal" data-target="#myModal"><i class="far fa-edit"></i>&nbsp;Edit</a>
                                                            <a href="brandViewModal.php?id=<?php echo base64_encode($row['brand_id']); ?>" class="btn btn-outline-secondary li-modal crud-btn" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="far fa-eye"></i>&nbsp;View</a>

                                                        </td>
                                                        <td>
                                                            <!-------------Active------------------>
                                                            <button onclick="activeInactiveBrand('<?php echo base64_encode($row['brand_id']); ?>',0)" class="btn btn-outline-success crud-btn" style="display:<?php echo $buttonInActive; ?>;width: 110px;"><i class="fas fa-toggle-on"></i>&nbsp;Active</button>
                                                            <!--------------Inactive------------------->
                                                            <button onclick="activeInactiveBrand('<?php echo base64_encode($row['brand_id']); ?>',1)" class="btn btn-outline-danger crud-btn" style="display:<?php echo $buttonActive; ?>;width: 110px;"><i class="fas fa-toggle-off"></i>&nbsp;Deactive</button>
                                                        </td>
                                                    </tr>
