                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header m-1">
                                <a href="addCategoryModal.php" class="btn btn-success li-modal" data-toggle="modal" data-target="#myModal" data-backdrop="static"><i class="fas fa-plus"></i>&nbsp;Add Category</a>
                            </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="table-responsive">
                                    <div id="categoryTbReload">
                                        <table id="categoryTable" class="table nowrap table-striped text-center" width="100%">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr scope="row">
                                                        ...
                                                        <td>
                                                            <img src="../../img/category_images/<?php echo $row['category_image']; ?>" style="width:auto;height:60px;border-radius:2px;" />
                                                        </td>
                                                        <td><?php echo $row['category_name']; ?></td>

                                                        <td>
                                                            <a href="editCategoryModal.php?id=<?php echo base64_encode($row['category_id']); ?>" class="btn btn-outline-info li-modal crud-btn" data-backdrop="static" data-toggle="modal" data-target="#myModal"><i class="far fa-edit"></i>&nbsp;Edit</a>
                                                            <a href="categoryViewModal.php?id=<?php echo base64_encode($row['category_id']); ?>" class="btn btn-outline-secondary li-modal crud-btn" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="far fa-eye"></i>&nbsp;View</a>
                                                        </td>
                                                        <td>
                                                            <!-------------Active------------------>
                                                            <button onclick="activeInactiveCategory('<?php echo base64_encode($row['category_id']); ?>',0)" class="btn btn-outline-success crud-btn" style="display:<?php echo $buttonInActive; ?>;width: 110px;"><i class="fas fa-toggle-on"></i>&nbsp;Active</button>
                                                            <!--------------Inactive------------------->
                                                            <button onclick="activeInactiveCategory('<?php echo base64_encode($row['category_id']); ?>',1)" class="btn btn-outline-danger crud-btn" style="display:<?php echo $buttonActive; ?>;width: 110px;"><i class="fas fa-toggle-off"></i>&nbsp;Deactive</button>
                                                        </td>
                                                    </tr>
