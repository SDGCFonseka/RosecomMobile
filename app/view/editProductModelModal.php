...
<div class="modal-header">
    <div class="modal-title modal-form-msg pt-2" id="prodModelEditResponse"></div>
    ...
    <div class="container">
        ...
        while ($viewRow = $productViewResult->fetch_assoc()) {
            ...
            if ($viewRow3['category_name'] == "phone" | $viewRow3['category_name'] == "Phone") {
                ...
                include('pModel_forms/editPhoneModel.php'); // phone adding form

            }else if($viewRow3['category_name'] == "headphone" | $viewRow3['category_name'] == "Headphone"){

                include('pModel_forms/editHeadphoneModel.php'); //headphone adding form
            }else{
